...
img.src = "https://icecube.wisc.edu/icecube/news/img/news_attachment.file.ad434dec89d7c9db.4845585f312e706e67.png"
//http://news.fnal.gov/wp-content/uploads/2015/10/microboone-first-neutrinos.jpg";
img.style.width = '100%'
...
window.onscroll = function() {
  ...
  if (document.body.scrollTop >= 700 || document.documentElement.scrollTop >= 700) {
	...
	myDrop.classList.add("scroll");
  } else {
    myNav.classList.remove("scroll");
	myDrop.classList.remove("scroll");
  }
};
